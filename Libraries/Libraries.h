...
enum codigos_de_operacion {
	...
	cop_handshake_SAFA_DAM = 10, //DAM espera conexiones de S-AFA
	cop_handshake_DAM_MDJ = 11, //DAM se conecta con MDJ
	cop_handshake_DAM_FM9 = 12, //
	cop_handshake_DAM_CPU = 13,
	cop_handshake_CPU_DAM = 14,
	cop_handshake_CPU_FM9 = 15,
	cop_handshake_CPU_SAFA = 16
};
